...
<Alloy>
    <ScrollView>
        <View class="mx-4 vertical">
            ...
            <TextArea class="w-screen -mx-1 text-xs italic font-thin text-gray-600">By Quint Forgey
07/17/2020 09:57 AM EDT
Updated: 07/17/2020 10:33 AM EDT</TextArea>

            <TextArea class="w-screen h-auto mx-auto mb-4 -mx-1 text-sm font-thin text-gray-600">Georgia Gov. Brian Kemp and Atlanta Mayor Keisha Lance Bottoms hurled insults at one another Friday, as their legal battle over whether to mandate masks in the state’s capital city entered its second day.
